        ...
        <div class="d-grid gap-2 d-md-block mx-auto">
            ...
            <?php
                ...
                foreach ($arrayResult as $dataKategori) {
                    echo '<a class="btn kategori-gb" type="button" href="?p=toko-kategori&id_kategori='.$dataKategori->id_kategori.'">'.$dataKategori->nama_kategori.'</a>';                
                    echo '</li>';   
                }
            ?> 
        </div>
